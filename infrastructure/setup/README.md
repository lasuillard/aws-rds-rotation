...
1. `terraform apply` to create initial database
    ...
    The RDS instance is provisioned, and database initialization is performed via `psql` over [Session Manager](https://docs.aws.amazon.com/systems-manager/latest/userguide/session-manager.html). We use [Pagila](https://github.com/devrimgunduz/pagila) sample dataset.
